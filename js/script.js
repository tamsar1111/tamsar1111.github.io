...
(function () {
	...
	let
			...
			plugins = {
				...
				svgProgress:             document.querySelectorAll( '.svg-progress' ),
			};
	...
	$(function () {
		...
		// SVG Progress
		if ( plugins.svgProgress.length ) {
			for ( let i = 0; i < plugins.svgProgress.length; i++ ) {
				let
					progressPath = plugins.svgProgress[i].querySelector( '.svg-progress-path' ),
				...
				lazyInit( $( plugins.svgProgress[i] ), addActive );
			}
		}
